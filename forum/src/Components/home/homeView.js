    ...
    return <div className="home-view">
        ...
        <div id="body" className="width">
            <section id="content" className="first-column-text">
                <article>
                    <h3>Introduction to deiform</h3>
                    <div className="article-info">Posted on 14 may by <a href="#" rel="author">Joe Bloggs</a></div>

                    <p>Welcome to deiform, a free valid CSS3 &amp; HTML5 responsive web template from <a href="http://zypopwebtemplates.com/" title="ZyPOP">ZyPOP</a>. This template is completely <strong>free</strong> to use permitting a link remains back to  <a href="http://zypopwebtemplates.com/" title="ZyPOP">http://zypopwebtemplates.com/</a>.</p>
                ...
                <article className="expanded">
                    ...
                    <h3>Buy unbranded</h3>
                    <div className="article-info">Posted on 14 Mayby <a href="#" rel="author">Joe Bloggs</a></div>
